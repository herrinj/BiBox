function [func, para, grad, hess] = imphase_rec(image, A, bispec_phase, weights, pupil_mask, ADA, alpha, reg_flag, pospec)
%
...
if doHess % returns the full, untruncated Hessian-matrix multiplication in
    ...
    switch reg_flag
        ...
        case{'pow',1}
            ...
            hess.flag = 'oper';
        case{'grad',2}
            hess.operator = @(pk) image_rec_hess_mult(pk, IMAGE, ADA, pupil_mask, alpha, reg_flag, R);
            hess.flag = 'oper';
    end               
end

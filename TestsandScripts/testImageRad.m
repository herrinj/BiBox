...
for j = 1:m
    ...
    [nfr, D_r0, image_name, K_n, sigma_rn, fourier_rad, second_rad]  = setupBispectrumParams('nfr',100,'D_r0',30,'fourier_rad',Rad(j));
    setupBispectrumData;

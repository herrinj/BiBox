...
figure; 
subplot(3,5,2);  imagesc(reshape(obj,[256 256])); axis image; axis off; colorbar; title('truth'); 
subplot(3,5,3);  imagesc(reshape(image_recur,[256 256])); axis image; axis off; colorbar; title('recur');
subplot(3,5,5);  imagesc(avg_data_frame); axis image; axis off; colorbar;  title('avg. blurred frame');

subplot(3,5,6);  imagesc(image_GD); axis image; axis off; colorbar;  title('Imphase - GD');
subplot(3,5,7);  imagesc(image_NLCG); axis image; axis off; colorbar;  title('Imphase - NLCG');
subplot(3,5,8);  imagesc(image_GNF); axis image; axis off; colorbar;  title('Imphase - GNF');
subplot(3,5,9);  imagesc(image_GNT); axis image; axis off; colorbar;  title('Imphase - GNT');
subplot(3,5,10); imagesc(image_GNI); axis image; axis off; colorbar;  title('Imphase - GNI');

subplot(3,5,11); imagesc(imagor_GD); axis image; axis off; colorbar;  title('Imphasor - GD');
subplot(3,5,12); imagesc(imagor_NLCG); axis image; axis off; colorbar;  title('Imphasor - NLCG');
subplot(3,5,13); imagesc(imagor_GNF); axis image; axis off; colorbar;  title('Imphasor - GNF');
subplot(3,5,14); imagesc(imagor_GNT); axis image; axis off; colorbar;  title('Imphasor - GNT');
subplot(3,5,15); imagesc(imagor_GNI); axis image; axis off; colorbar;  title('Imphasor - GNI');
...
leg = legend('E1-GD','E2-GD','E1-NLCG','E2-NLCG',...
